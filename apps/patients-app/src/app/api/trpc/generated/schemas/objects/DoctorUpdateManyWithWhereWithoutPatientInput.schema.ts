...
const Schema: z.ZodType<Prisma.DoctorUpdateManyWithWhereWithoutPatientInput> = z
  .object({
...
export const DoctorUpdateManyWithWhereWithoutPatientInputObjectSchema = Schema
