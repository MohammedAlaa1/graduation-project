...
const Schema: z.ZodType<Prisma.DoctorUpdateManyWithoutPatientNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => DoctorUpdateManyWithWhereWithoutPatientInputObjectSchema),
        z
          .lazy(() => DoctorUpdateManyWithWhereWithoutPatientInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const DoctorUpdateManyWithoutPatientNestedInputObjectSchema = Schema
