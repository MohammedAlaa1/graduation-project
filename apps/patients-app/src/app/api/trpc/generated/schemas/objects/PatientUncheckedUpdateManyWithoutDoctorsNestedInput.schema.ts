...
const Schema: z.ZodType<Prisma.PatientUncheckedUpdateManyWithoutDoctorsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => PatientUpdateManyWithWhereWithoutDoctorsInputObjectSchema
          ),
          z
            .lazy(
              () => PatientUpdateManyWithWhereWithoutDoctorsInputObjectSchema
...
export const PatientUncheckedUpdateManyWithoutDoctorsNestedInputObjectSchema =
  Schema
