...
const Schema: z.ZodType<Prisma.DoctorUncheckedUpdateWithoutAppointmentInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const DoctorUncheckedUpdateWithoutAppointmentInputObjectSchema = Schema
