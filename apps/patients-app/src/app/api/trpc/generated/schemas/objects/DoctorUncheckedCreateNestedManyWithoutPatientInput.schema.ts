...
const Schema: z.ZodType<Prisma.DoctorUncheckedCreateNestedManyWithoutPatientInput> =
  z
    .object({
      create: z
        .union([
...
export const DoctorUncheckedCreateNestedManyWithoutPatientInputObjectSchema =
  Schema
