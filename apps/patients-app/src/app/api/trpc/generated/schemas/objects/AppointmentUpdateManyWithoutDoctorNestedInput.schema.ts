...
const Schema: z.ZodType<Prisma.AppointmentUpdateManyWithoutDoctorNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AppointmentUpdateManyWithoutDoctorNestedInputObjectSchema = Schema
